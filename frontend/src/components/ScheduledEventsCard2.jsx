...
const ScheduledEventsCard2 = () => {
    
  return (
    <React.Fragment>
        <div className="col-lg-4 col-md-6">
            <div className="card card-block card-stretch card-height">
                <div className="card-body rounded event-detail event-detail-danger">
                    <div className="d-flex align-items-center justify-content-between mb-4">
                        <div>
                            <h3 className="text-danger">{event.date}</h3>
                        </div>
                    ...
                    <p className="mb-2 text-danger"><i className="las la-clock mr-3"></i>{event.time}</p>
                    <p className="mb-2 text-danger"><i className="las la-map-marker mr-3"></i>{event.location}</p>
                </div>
            </div>
        </div>
    </React.Fragment>
...
export default ScheduledEventsCard2